...
import { Send, CheckCircle2, MapPin, Mail, Phone, Clock, ArrowRight, Shield } from 'lucide-react';
...
export const ContactSection: React.FC<ContactSectionProps> = ({ prefilledData }) => {
  ...
  return (
    <section id="inquire" className="py-24 sm:py-32 px-6 sm:px-8 lg:px-16 bg-[#0D0D0D] relative">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            {isSubmitted ? (
              <div className="text-center py-12 space-y-6">
                ...
                <p className="text-sm text-[#D8D0C5] max-w-md mx-auto font-light leading-relaxed">
                  Thank you, <strong className="text-[#EDE6D8]">{formData.clientName}</strong>.
                  Directors Aarushi Panda and Tejaswi MK will review your space specifications and
                  connect directly within 24 hours.
                </p>
                <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-[#0D0D0D] border border-[#EDE6D8]/15 text-sm text-[#EDE6D8] focus:border-[#B08C4A] focus:outline-none"
                    >
                      <option value="Private Penthouse & Residence">Private Penthouse & Residence</option>
                      <option value="Boutique Hotel & Cocktail Lounge">Boutique Hotel & Cocktail Lounge</option>
                      <option value="Haute Retail & Aesthetic Clinic">Haute Retail & Aesthetic Clinic</option>
                      <option value="Private Collector Gallery & Salon">Private Collector Gallery & Salon</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setFormData({ ...formData, doseLevel: e.target.value })}
                      className="w-full px-4 py-3 bg-[#0D0D0D] border border-[#EDE6D8]/15 text-sm text-[#EDE6D8] focus:border-[#B08C4A] focus:outline-none"
                    >
                      <option value="Subtle Layering">Subtle Layering (Dose 01)</option>
                      <option value="High-Voltage Drama">High-Voltage Drama (Dose 02)</option>
                      <option value="Opulent Sanctum">Opulent Sanctum (Dose 03)</option>
                    </select>
                  </div>
                </div>
          ...
          {/* Right Column: Studio Information & Placeholders (5 cols) */}
          <div className="lg:col-span-5 space-y-8 flex flex-col justify-between">
            <div className="space-y-6">
              <div className="p-6 bg-[#1E1E1E]/50 border border-[#EDE6D8]/10">
                ...
                <div className="space-y-3 text-xs text-[#D8D0C5]/90 font-light">
                  <p>
                    <strong className="text-[#EDE6D8] font-medium block">Head Atelier (India):</strong>
                    [STUDIO ATELIER — BY APPOINTMENT ONLY, LAVELLE ROAD, BANGALORE 560001]
                  </p>
                  <p>
                    <strong className="text-[#EDE6D8] font-medium block">Consultation Hubs:</strong>
            ...
            <div className="p-4 bg-[#0D0D0D] border border-[#EDE6D8]/10 flex items-center gap-4">
              ...
              <div className="text-[11px] text-[#887961]">
                <span className="text-[#EDE6D8] font-medium">Aarushi Panda & Tejaswi MK</span>
